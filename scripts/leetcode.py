...
class Config:
    ...
    这里需要配置你自己的项目地址
    １．&emsp;本地仓库的的路径
    ２．&emsp;github中的仓库leetcode解法的路径
    """
    local_path = '/Users/creepiz/Documents/Projects/Github/leetcode'
...
class Question:
    ...
    def __init__(self, id_,
                 name, url,
                 lock, difficulty,pass_):
        self.id_ = id_
        self.title = name
        # the problem description url&emsp;问题描述页
        self.url = url
...
class TableInform:
    ...
    def get_leetcode_problems(self):
        ...
        for i in range(len(self.questions) - 1, -1, -1):
            ...
            q = Question(id_, name, url, lock, difficulty, pass_)
    ...
    def update_table(self, oj):
        ...
        complete_info.pass_ = self.pass_
...
class Readme:
    ...
    def __init__(self, total, solved, locked, pass_, others):
        """
